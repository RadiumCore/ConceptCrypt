...
export class Verify extends React.Component<RouteComponentProps<{}> | undefined, State> {
                ...
                <div className="row">
                    <div className="col-md-3 " >
                        ...
                        <div className="col-md-9 " >
                            <h3>Upload the original, unaltered file to verify that it has been previously recorded in the blockchain.</h3>                        <div className="custom-file">
