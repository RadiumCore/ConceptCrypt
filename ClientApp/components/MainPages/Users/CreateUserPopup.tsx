        ...
        return (<Modal backdrop={"static"} show={true} onHide={this.props.close_callback}>
            ...
            <Modal.Body>
                ...
                <div className="input-group">
                    ...
                    <input type="text" className="form-control" placeholder="Address" aria-describedby="basic-addon1" name="streetaddress" value={this.state.user.streetaddress} onChange={e => { this.setState({ user: { ...this.state.user, streetaddress: e.target.value } }) }} ></input>
                </div>
                <p />
                <div className="input-group">
                ...
                <p />
                <div className="input-group">
                    <span className="input-group-addon" id="basic-addon1">Email Address:</span>
